...
namespace pmo.Models
{
    public class SearchModel
    {
        ...
        //    SqlCommand cmd = new SqlCommand("insert Into VisitorContact (Name, Email,mobile,ProjectType,ProjectAge,Location,Budget,ContactDate) values(@Name, @EmailID,@mobile,@ProjectType,@ProjectAge,@Location,@Budget,@ContactDate)", conn);
